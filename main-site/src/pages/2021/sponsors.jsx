...
import SocialButton from "../../2021/components/SocialButton";
...
const SponsorSectionPrimary = ({sponsorList, isMobile}) => (
    <div className="pr-8 sm:pr-12">
        <div className="flex opacity-60">
            <div
                className="text-sm sm:text-base inline-block whitespace-nowrap uppercase tracking-widest mr-6 align-middle">
                01<span className="ml-2">Platinum Sponsors</span>
            </div>
            <div className="ruler"/>
        </div>
        <div
            className="grid grid-rows-3 sm:grid-rows-2 grid-flow-col gap-x-4 gap-y-4 sm:gap-x-24 sm:gap-y-8 mt-6 sm:mt-10">
