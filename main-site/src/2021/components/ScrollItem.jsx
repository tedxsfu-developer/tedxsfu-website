...
import {SimpleDivAnimation} from "../../shared/components/animation/SimpleTransitionAnimation";
        ...
        >
            ...
            <div className="mt-flowline-mobile ml-document absolute font-medium z-10">
                ...
                <SimpleDivAnimation>
                    ...
                    <div
                        className="mt-1 text-sm w-96 mt-4 leading-4 2xl:ml-axis border-l-2 border-white p-0 pl-4 md:block hidden">
                        {speaker.description}
                        {/* {!speaker.videoReady && (
